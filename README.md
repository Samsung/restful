...
##### Note #####
  - [x] [/restful/note/create.html](/restful/note/create.html "Creating new note")
  - [x] [/restful/note/update.html](/restful/note/update.html "Updating note")
  - [x] [/restful/note/content.html](/restful/note/content.html "Retrieving note content")
  - [x] [/restful/note/list.html](/restful/note/list.html "Retrieving note list")
