...
##### User #####
  ...
  - [x] [/restful/user/setting.html](/src/main/webapp/user/setting.html "Updating/Deleting user's information")
  - [x] [/restful/user/user.html](/src/main/webapp/user/user.html "Retrieving user's information") (_admin only_)
